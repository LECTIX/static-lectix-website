...
const productSeeds: ProductSeed[] = [
  ...
  },
  {
    ...
    summary: "Détecte l’occupation d’une voie DCC jusqu’à 3 A pour la signalisation, le cantonnement et les automatismes.",
    ...
    manualPages: 12,
    introduction:
      "Ce module détecte locomotives, wagons éclairés et feux de fin de convoi sur une zone DCC. Son relais double inverseur peut commander la signalisation, un cantonnement, une voie cachée ou un autre automatisme.",
    features: [
      "Détection dans les deux sens de circulation",
      "Sensibilité réglable de 1 à 10 mA",
      "Courant maximal supporté de 3 A",
      "Relais double inverseur libre de potentiel",
      "Temporisation à la désactivation et entrée FORCE",
    ],
  },
  {
  ...
  },
  {
    ...
    category: "Analogique",
    summary: "Détecte l’occupation d’une voie analogique pour la signalisation, le cantonnement et les automatismes.",
    ...
    manualPages: 6,
    introduction:
      "Ce module détecte une locomotive, un wagon éclairé ou un essieu graphité sur une zone analogique. Son relais double inverseur peut commander un feu, un cantonnement ou un autre automatisme.",
    features: [
      "Détection dans un sens de circulation à partir de 6 V",
      "Détection des wagons éclairés et essieux graphités",
  ...
  },
  {
    ...
    category: "Digital DCC",
    summary: "Détecte l’occupation d’une voie DCC jusqu’à 1 A pour la signalisation, le cantonnement et les automatismes.",
    ...
    manualPages: 13,
    introduction:
      "Ce module détecte locomotives, wagons éclairés et essieux graphités sur une zone DCC. Son relais double inverseur peut commander la signalisation, un cantonnement, une voie cachée ou un autre automatisme.",
    features: [
      "Détection dans les deux sens de circulation",
      "Détection d’un décodeur même lorsque la locomotive est à l’arrêt",
      "Seuil de détection réglable",
      "Relais double inverseur libre de potentiel",
      "Temporisation à la désactivation et entrée FORCE",
    ],
